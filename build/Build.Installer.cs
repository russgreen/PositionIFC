...
partial class Build
{
    ...
    .Executes(() =>
    {
        var aipProjectPath = Path.Combine(RootDirectory, @"Installer\PositionIFC.aip");
        var version = Solution.PositionIFC.GetProperty("Version");
    ...
    {
        var aipOutputPath = Path.Combine(RootDirectory, @"Installer\PositionIFC-SetupFiles");
